...
import { mainMenuItems, secondaryMenuItems } from "../components/LeftNavMenuItems";
        ...
        <div className='big-image'>
            <div className="overlay">
                ...
                <div>
                    ...
                    <p className="hero-subtext">Your handy dandy Video Streaming Subscription Ready-Reckoner!</p>
                </div>
            </div>
        </div>
    );
